...
%[manmadeTrainingData, manmadeTrainingIdentity] = removeNans2(manmadeTrainingData, manmadeTrainingIdentity);
...
Mdl = TreeBagger(50, trainingData, trainingIdentity, 'Method', 'classification');
